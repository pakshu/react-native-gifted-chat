...
export default class MessageContainer extends React.PureComponent {
  ...
  constructor(props) {
    ...
    this.renderFooterWrapper = this.renderFooterWrapper.bind(this);
  ...
  renderHeaderWrapper() {
    if (this.props.inverted) {
      return <View style={styles.headerWrapper}>{this.renderFooter()}</View>;
    } else {
      return <View style={styles.headerWrapper}>{this.renderHeader()}</View>;
    }
  }

  renderFooterWrapper() {
    if (this.props.inverted) {
      return <View style={styles.headerWrapper}>{this.renderHeader()}{this.renderLoadEarlier()}</View>;
    } else {
      return <View style={styles.headerWrapper}>{this.renderLoadEarlier()}{this.renderFooter()}</View>;
    }
  }
    ...
    return (
      <View style={styles.container}>
        <FlatList
          ...
          ListFooterComponent={this.renderFooterWrapper}
